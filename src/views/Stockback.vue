    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-12 box" v-if="!stockback.confirmed">
        ...
        <div class="columns is-multiline">
          <div class="field column is-6">
              <label>单号</label>
              <div class="control">
                <input type="text" class="input" v-model="stockback.code" placeholder="自动生成" disabled>
              </div>
          </div>
          <div class="field column is-6">
              <label>日期</label>
              <div class="control">
              <input type="text" class="input" v-model="stockback.create_date" placeholder="自动生成" disabled>
              </div>
          </div>
          <div class="field column is-6">
              <label>部门*</label>
      ...
      <div class="column is-12 box" v-else>
        ...
        <div class="columns is-multiline">
          ...
          <div class="field column is-6">
            <p class="is-medium">
              日期: {{ stockback.create_date }} 
            </p>
          </div>
          <div class="field column is-6">
            <p class="is-medium">
              部门: {{ departments.filter(d=>d.id==stockback.department)[0].name }} 
            </p>
          </div>
          <div class="field column is-6">
            <p class="is-medium">
              人员: {{ employees.filter(e=>e.id==stockback.employee)[0].user.username }} 
            </p>
          </div>
          <div class="field column is-6">
            <p class="is-medium">
